...
export class WorkersKv {
     ...
     */
    constructor(accountEmail, accountId, globalApiKey, isValidateCfResponse = true, ...extensionArg) {
        /**Functions' aliases */
    ...
    async bridge(command, http, validateCfResponseMethod = "full") {
        try {
            ...
            this.funcArgHandlers(cfFetch.isCfReqSuccess, command, cfFetch, cfFetch.cfError);
            return cfFetch;
        }
        catch (err) {
